...
[***TEMP. DEMO HERE***](https://scaleflex.cloudimg.io/v7/plugins/filerobot-image-editor/v4_beta-demo/index.html?vh=6b308a&func=proxy)
...
| **`ratioTitleKey`**  | string                                           | 'original' or crop's `ratio` if provided                   | The title's translation key of the crop's ratio selected that will be shown initially besides the crop's tool icon                                                                                                                  |
