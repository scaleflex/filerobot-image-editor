...
[![Release](https://img.shields.io/badge/release-v3.12.5-blue.svg)](https://github.com/scaleflex/filerobot-image-editor/releases)
...
```html
<script src="https://cdn.scaleflex.it/plugins/filerobot-image-editor/3.12.5/filerobot-image-editor.min.js"></script>
```
