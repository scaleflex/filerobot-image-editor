...
[![Release](https://img.shields.io/badge/release-v3.6.0-blue.svg)](https://github.com/scaleflex/filerobot-image-editor/releases)
...
```html
<script src="https://cdn.scaleflex.it/plugins/filerobot-image-editor/3.6.0/filerobot-image-editor.min.js"></script>
```
